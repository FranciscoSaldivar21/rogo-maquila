...
<html>
    ...
    <script>
        function validar(){
            ...
            if(telefono == '' || nombre == '' || correo == ''){
                ...
                document.forma01.action = 'registroProveedorBack.php';
    ...
    <body>
        <P SIZE="5" align='center'>AGREGAR PROVEEDOR</P>
        <div id = "principal">
            <form name = "forma01">
        ...
        <div id="divBoton">
            <a href = "tablaProveedor.php"><button class = "boton">Cancelar</button>
        </div>
    </body>
</html>