...
<script>
    function validar() {
        ...
        if (nombre == '' || telefono == '' || correo == '' || domicilio == '') {
			...
			document.forma01.action = 'actualizaCliente.php';
...
<body>
    <P SIZE="5" align='center'>EDICION CLIENTE</P>
    <?php
        ...
        while ($row = $res->fetch_array()) {
            ...
            echo "<div id = \"principal\">";
                echo "<form name = \"forma01\">";
                    echo "<input id=\"id\" name=\"idCliente\" type=\"hidden\" value=\"$id\">";
                    ...
                    echo "<label for = \"domicilio\">Domicilio<input type = \"text\" name = \"domicilio\" value = \"$domicilio\" id = \"domicilio\"/></label><br>";
        ...
        ?>
    <div id="divBoton">
        <a href = "tablaClientes.php"><button class = "boton">Regresar</button>
    </div>
</body>
